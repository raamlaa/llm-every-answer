    ...
    const SearchResultsSkeleton = () => (
        <>
            ...
            <div className="w-full sm:w-full md:w-1/4 p-2">
                <div className="flex items-center space-x-2  bg-gray-100 p-3 rounded-lg h-12 justify-center">
                    <div className="w-5 h-5  bg-gray-400 rounded animate-pulse"></div>
                    <div className="w-5 h-5  bg-gray-400 rounded animate-pulse"></div>
                    <div className="w-5 h-5  bg-gray-400 rounded animate-pulse"></div>
                    <div className="w-full h-4  bg-gray-400 rounded animate-pulse"></div>
                        ...
                        {visibleResults.map((result, index) => (
                            <div key={`searchResult-${index}`} className="p-2 w-full md:w-1/4">
                                <div className="flex items-center space-x-2  bg-gray-100 p-3 rounded-lg h-full">
                                    ...
                                    />
                                    <a href={result.link} target="_blank" rel="noopener noreferrer" className="text-sm font-semibold truncate   text-gray-700 hover:text-black">
                                        {result.title}
                                    </a>
                                </div>
                            </div>
                            ...
                            >
                                {!isExpanded ? (
                                    <>
                                        ...
                                        <span className="text-sm font-semibold  text-gray-700">View more</span>
                                    </>
                                ) : (
                                    <span className="text-sm font-semibold  text-gray-700">Show Less</span>
                                )}
                            </div>
                        </div>
                    </>
