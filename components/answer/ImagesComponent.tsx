    ...
    const ImagesSkeleton = () => (
        <>
            ...
            {/* <div className="flex justify-center mt-4 w-full">
                <div className="bg-gray-300  rounded-lg animate-pulse py-5 px-15 " style={{ height: '24px', width: '85px' }}></div>
            </div> */}
        </>
    );
    ...
    return (
        <div className="bg-white shadow-lg rounded-lg p-4 mt-4">
            <div className="flex items-center">
                <h2 className="text-lg font-semibold flex-grow text-black">Images</h2>
