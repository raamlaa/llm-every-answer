...
export default function Page() {
  ...
  return (
    <div>
      ...
      <div className={`px-2 fixed inset-x-0 bottom-0 w-full bg-gradient-to-b duration-300 ease-in-out animate-in  dark:from-10% peer-[[data-state=open]]:group-[]:lg:pl-[250px] peer-[[data-state=open]]:group-[]:xl:pl-[300px]] mb-4 bring-to-front`}>
        <div className="mx-auto max-w-xl sm:px-4 ">
          ...
          >
            <div className="relative flex flex-col w-full overflow-hidden max-h-60 grow text-black  bg-gray-100 rounded-md border sm:px-2">
              <Textarea
                ref={inputRef}
                tabIndex={0}
                onKeyDown={onKeyDown}
                placeholder="Tell me Something..."
                className="w-full resize-none bg-transparent px-4 py-[1.3rem] focus-within:outline-none sm:text-sm  text-black pr-[45px]"
                autoFocus
                spellCheck={false}
                autoComplete="off"
                autoCorrect="off"
